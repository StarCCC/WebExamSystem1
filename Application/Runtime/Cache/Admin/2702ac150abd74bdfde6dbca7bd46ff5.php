                    ...
                    <div class="raw">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" id="thisform" action="<?php echo U('Problem/setReadC');?>" method="POST">
                        ...
                        <div class="raw">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <button type="button" class="btn btn-warning" onclick="location.href='<?php echo U("Problem/readCode");?>'">返回</button>
                            </div>
                        </div>
                    </div>
                </div>
