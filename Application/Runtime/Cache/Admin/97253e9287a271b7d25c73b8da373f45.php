                ...
                <div class="container">
                    <div class="raw">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="<?php echo U("Problem/wCode");?>">编写程序题</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="raw">
                        ...
                        <div class="col-md-8 no-padding">
                            <div class="btn-group pull-right">
                                <button type="button" class="btn btn-warning" onclick="location.href='<?php echo U("Problem/wCodeadd");?>'">
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <li><a href="<?php echo U('Problem/wCodeedit',array('id'=>$vo['id'],'op'=>0));?>">详情</a></li>
                                    <li><a href="<?php echo U('Problem/wCodeedit',array('id'=>$vo['id'],'op'=>1));?>">修改</a></li>
                                    <li><a href="<?php echo U('Problem/delWCode',array('id'=>$vo['id']));?>">删除</a></li>
                                    </ul>
                                </td>
                    ...
                    <div class="raw">
                        <button type="button" class="btn btn-warning" onclick="location.href='<?php echo U('Problem/wCode',array('pageNum'=>1));?>'">首&nbsp&nbsp页</button>
                        <?php if($nowpage > 1): ?><button type="button" class="btn btn-warning" onclick="location.href='<?php echo U('Problem/wCode',array('pageNum'=>$nowpage-1));?>'">上一页</button>
                        <?php else: ?>
                        <button type="button" class="btn btn-warning" disabled="disabled">上一页</button><?php endif; ?>
                        <?php if($nowpage < $total): ?><button type="button" class="btn btn-warning" onclick="location.href='<?php echo U('Problem/wCode',array('pageNum'=>$nowpage+1));?>'">下一页</button>
                        <?php else: ?>
                        <button type="button" class="btn btn-warning" disabled="disabled">下一页</button><?php endif; ?>
                        <button type="button" class="btn btn-warning" onclick="location.href='<?php echo U('Problem/wCode',array('pageNum'=>$total));?>'">末&nbsp&nbsp页</button>
                    </div>
                </div>
            </div>
        </div>
