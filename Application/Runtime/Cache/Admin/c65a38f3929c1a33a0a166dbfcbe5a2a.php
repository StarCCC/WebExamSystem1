                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" id="thisform" action="<?php echo U('Problem/setCode');?>" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="correct1" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">正确答案2</label>
                                            <div class="col-md-10">
                                                <input type="text" name="correct2" />
                                            </div>
                                        </div>
                                        <div class="form-group">
