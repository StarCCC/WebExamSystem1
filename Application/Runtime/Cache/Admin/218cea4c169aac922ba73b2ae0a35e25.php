                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr><td>选项A</td><td><?php echo ($prb['citema']); ?></td></tr>
                                            <tr><td>选项B</td><td><?php echo ($prb['citemb']); ?></td></tr>
                                            <tr><td>选项C</td><td><?php echo ($prb['citemc']); ?></td></tr>
                                            <tr><td>选项D</td><td><?php echo ($prb['citemd']); ?></td></tr>
                                            <tr><td>正确答案</td><td><?php echo ($prb['icorrect']); ?></td></tr>
                        ...
                        <div class="raw">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form class="form-horizontal" role="form" id="thisform" action="<?php echo U('Problem/setSelect',array('id'=>$prb['id']));?>" method="POST">
                                            ...
                                            <input type="text"  name="subid" value="<?php echo ($prb['isubid']); ?>" style="display:none;" />
                                            <input type="text"  name="chaid" value="<?php echo ($prb['ichaid']); ?>" style="display:none;" />
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="itema" value="<?php echo ($prb['citema']); ?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">选项B</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="itemb" value="<?php echo ($prb['citemb']); ?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">选项C</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="itemc" value="<?php echo ($prb['citemc']); ?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">选项D</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="itemd" value="<?php echo ($prb['citemd']); ?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
